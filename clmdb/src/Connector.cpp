...
corto_int16 _clmdb_Connector_construct(
    clmdb_Connector _this)
{
/* $begin(remuv/clmdb/Connector/construct) */
...
corto_void _clmdb_Connector_destruct(
    clmdb_Connector _this)
{
/* $begin(remuv/clmdb/Connector/destruct) */
...
corto_void _clmdb_Connector_onNotify(
    ...
    corto_result *object)
{
/* $begin(remuv/clmdb/Connector/onNotify) */
...
/* $header(remuv/clmdb/Connector/onRequest) */
...
{
/* $begin(remuv/clmdb/Connector/onRequest) */
